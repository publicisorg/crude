    ...
    <>
      ...
      <main className={`w-full`}>
        ...
        <Routes>
          ...
          <Route path="/myprofile" element={<div className={`${containerStyles}`}><ProfileUsers urlImgPortada={urlImgPortada} userId={userId} name={name} lastName={lastname} urlImg={urlImg} rol={role} occupation={occupation} userNick={userNick} active={active} idLikeStatus={idLikeStatus} secondaryColor={props.secondaryColor} borderColor={props.borderColor}/></div>} />
          <Route path="/profile/:userNick" element={<div className={`${containerStyles}`}><ProfileUsersPublic /></div>} />
          <Route path="/tasks" element={
            ...
            || (role == "supervisor" || role == "account") && <div className={`${containerStyles}`}><TasksTable role={role} handleTimer={handleTimer} userFilter={"*"} secondaryColor={props.secondaryColor} borderColor={props.borderColor}/></div>
          }></Route>
