        ...
        <aside className="h-screen fixed gap-2 bg-gradient-to-b from-black/40 to-black/10 dark:from-white/25 dark:to-white/10 w-80 border-r border-black/10 dark:border-white/25 flex justify-between flex-col  items-center">
            <div className="flex flex-col justify-evenly">
                ...
                <div className="flex flex-col justify-center items-center w-full gap-1 px-4 ">
                    <MenuButton secondaryColor={props.secondaryColor} function={setMenuSelected} arguments="/" selected={menuSelected} px="px-8"><AiOutlineStar />   Noticias</MenuButton>
                    <MenuButton secondaryColor={props.secondaryColor} function={setMenuSelected} arguments="desktop" selected={menuSelected} px="px-8"><AiOutlineHome />   Escritorio</MenuButton>
                    <MenuButton secondaryColor={props.secondaryColor} function={setMenuSelected} arguments="notifications" selected={menuSelected} px="px-8">
                        <AiOutlineBell />
                        Actividad
                        {notificationDing()}
                    </MenuButton>
                    <MenuButton secondaryColor={props.secondaryColor} function={setMenuSelected} arguments="tasks" selected={menuSelected} px="px-8"><AiOutlineContainer />Tareas</MenuButton>
                    {props.role == "supervisor" && <MenuButton secondaryColor={props.secondaryColor} function={setMenuSelected} arguments="createtasks" selected={menuSelected} px="px-8"><AiOutlineContainer />Crear Tareas</MenuButton>}
                    <MenuButton secondaryColor={props.secondaryColor} function={setMenuSelected} arguments="folders" selected={menuSelected} px="px-8"><AiOutlineFolder />Carpetas</MenuButton>
                    {false && <MenuButton secondaryColor={props.secondaryColor} function={setMenuSelected} arguments="databases" selected={menuSelected} px="px-8"><AiOutlinePieChart />Bases de Datos</MenuButton>}
                </div>
            </div>
