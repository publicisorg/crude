...
function MenuAside(props: any) {
    ...
    return (
        <aside className="h-screen fixed gap-2  w-full  lg:w-80 border-r flex justify-between flex-col items-center shadow-lg" style={{ borderColor: props.borderColor, backgroundColor: props.cardBg }}>
            <div className="flex flex-col justify-evenly">
                <div className="pb-8 px-6  w-full flex justify-center">
                    <div className="my-9 w-full flex justify-center items-center p-2">
                        <img className="w-1/2" src="https://crude-thepub.netlify.app/ThePub-Black.png" />
                    </div>
                </div>
