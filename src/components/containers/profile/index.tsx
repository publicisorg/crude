    ...
    return (
        <main>
            <div className="mx-auto p-8">
                <div className='border rounded-lg overflow-hidden pb-6  shadow-lg' style={{borderColor: props.borderColor, backgroundColor:  props.cardBg }}>
                ...
                <div className="card my-4 shadow-lg" style={{borderColor: props.borderColor, backgroundColor:  props.cardBg }}>
