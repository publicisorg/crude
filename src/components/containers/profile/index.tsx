        ...
        <main>
            ...
            <div className="grid grid-cols-1 px-4 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-black">
                ...
                <div className="col-span-full xl:col-auto">
                    ...
                    <div className="p-4 mb-4 bg-white/10 border border-gray-200/10 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700/10 sm:p-6 dark:bg-white/10/10">
                        <div className="flow-root">
                            <h3 className="text-xl font-semibold dark: ">Personaliza tu perfil</h3>
                                ...
                                <li className="py-4">
                                    <div className="flex items-center space-x-4">
                                        <div className="flex-shrink-0">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5 dark: " version="1.1" id="_x32_" viewBox="0 0 512 512" >
                                                <g>
                ...
                <div className="col-span-2">
                    <div className="p-4 mb-4 bg-white/10 border border-gray-200/10 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700/10 sm:p-6 dark:bg-white/10/10">
                        <h3 className="mb-4 text-xl font-semibold dark: ">Información general</h3>
                        <form action="#">
                    ...
                    <div className="p-4 mb-4 bg-white/10 border border-gray-200/10 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700/10 sm:p-6 dark:bg-white/10/10">
                        <h3 className="mb-4 text-xl font-semibold dark: ">Actualizar Password</h3>
                        <form action="#">
                            <div className="grid grid-cols-6 gap-6">
                                <div className="col-span-6 sm:col-span-3">
